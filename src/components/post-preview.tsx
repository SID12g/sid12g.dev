  ...
  return (
    <section className="mb-10">
      ...
      <Link
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center justify-center gap-1 mt-4 py-2.5 rounded-lg border border-neutral-200 dark:border-neutral-800 text-sm text-neutral-500 dark:text-neutral-400 hover:bg-neutral-50 dark:hover:bg-neutral-900 hover:text-neutral-700 dark:hover:text-neutral-300 transition-colors"
      >
        더보기
        <svg
