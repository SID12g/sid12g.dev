...
export default function Detail({
  ...
  return (
    <div className="overflow-scroll overflow-x-hidden fixed inset-0 bg-primary-color sm:bg-neutral-800/50 flex justify-center sm:pt-[60px] px-[0px] sm:px-[16px] md:px-[60px]">
