...
function StackItem({ stack }: { stack: string }) {
  return (
    <div className="flex flex-row items-center gap-2 py-2 px-4 bg-muted-15 border-faint border rounded-full w-fit hover:border-accent hover:bg-hover transition-colors duration-150 cursor-default">
